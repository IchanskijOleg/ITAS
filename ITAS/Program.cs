    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                {
                    OracleDataReader reader = new OracleCommand(item, conn).ExecuteReader();
                    if (reader != null) { ds.Load(reader, LoadOption.OverwriteChanges, string.Empty); }
                }
